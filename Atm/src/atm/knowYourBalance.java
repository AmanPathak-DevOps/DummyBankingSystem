 ...
 * @author Aman
 */
public class knowYourBalance extends javax.swing.JFrame {

    /**
     * Creates new form knowYourBalance
     */
    public knowYourBalance() {
        initComponents();
        showDate();
        showTime();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(knowYourBalance.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new knowYourBalance().setVisible(true);
            }
        });
    }
